...
<header>
  ...
  <table>
    ...
    <tbody>
      ...
      $stmt = $req->prepare("SELECT id, name FROM category ORDER BY id");
      $stmt->execute();
      ...
      for ($i=0; $i < count($resultat); $i++) { 
        ...
        print_r("<td class=\"modif\"><button id=\"modif{.$i}\"><a href=\"./edit_category.php?id={$resultat[$i][0]}\">Modifier</a></button></td>");
        print_r("<td class=\"suppr\"><button id=\"suppr{.$i}\"><a href=\"./del_category.php?id={$resultat[$i][0]}\">Supprimer</a></button></td>");
        echo "</tr>";
      }
