...
<header>
  ...
  <form action="./validation_ajout_category.php" method="post">
    <h1>Ce n'est pas un formulaire, c'est une création de catégorie,<br> je valide et je me concentre</h1>
    <div class="form-container">
      <label for="nom">Nom</label>
      <input class="input" type="text" name="nom" id="nom">
    </div>
    <input type="submit" value="Validation avec Création de Catégorie">
  </form>
